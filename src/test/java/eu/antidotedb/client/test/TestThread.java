...
class TestThread implements Runnable {
    ...
    public void run() {
        try{
            ...
            //user1
            S3Statement statement1 = new S3Statement(true, Arrays.asList("user1"), Arrays.asList("*"), Arrays.asList("object1TestS3"), "");
            S3Statement statement2 = new S3Statement(true, Arrays.asList("user1"), Arrays.asList("*"), Arrays.asList("object2TestS3"), "");
            ...
            //user3
            S3Statement statement3 = new S3Statement(true, Arrays.asList("user3"), Arrays.asList("*"), Arrays.asList("object1TestS3"), "");
            S3Statement statement4 = new S3Statement(true, Arrays.asList("user3"), Arrays.asList("*"), Arrays.asList("object2TestS3"), "");
